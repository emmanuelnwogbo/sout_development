...
class _MyCircleState extends State<MyCircle> {
  ...
  void _getContactsStorage() async {
    ...
    var contactsFromStorage = prefs.getStringList('locallyStoredContacts');
                                                            ...
                                                            child: _contacts !=
                                                                ...
                                                                ? ListView
                                                                    .builder(
                                                                        ...
                                                                        itemBuilder:
                                                                            (_, int index) {
                                                                          return _contacts.elementAt(index).phones.toList().length > 0 && addedNums.contains(_contacts.elementAt(index).phones.toList()[0].value.toString())
                                                                              ? Container(
                                                                                      ...
                                                                                      Positioned(
                                                                                          ...
                                                                                          child: Row(
                                                                                            ...
                                                                                            children: <Widget>[
                                                                                              ...
                                                                                              Text(truncateWithEllipsis(18, _contacts.elementAt(index).displayName), textAlign: TextAlign.start, style: TextStyle(letterSpacing: .8, color: Colors.black, fontSize: 15.0, fontWeight: FontWeight.w400))
                                                                                            ],
                                                                                          )),
                                                                                      Positioned(
                                                                                          right: 1.0,
                                                                                          ...
                                                                                          child: GestureDetector(
                                                                                              onTap: () {
                                                                                                _contacts.elementAt(index).phones.toList().forEach((number) {
                                                                                                  var nums = addedNums;
                                                                                                  nums.contains(number.value.toString()) && nums.remove(number.value.toString());
